                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class=" text-center">
                                                            ...
                                                            <a href="userregister.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Do you really want to Delete ?');" title="Block this User" class=" btn btn-danger rounded"><i class="mdi mdi-block-helper"></i></a>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
